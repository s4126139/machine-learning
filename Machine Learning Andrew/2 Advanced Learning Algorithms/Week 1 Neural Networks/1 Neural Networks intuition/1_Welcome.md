...
This course introduces two powerful and widely used families of machine learning algorithms:

- **Neural networks**, also called **deep learning algorithms**
- **Decision trees**

It also provides practical guidance for building machine learning systems. A practitioner often has to decide, for example, whether to spend more time collecting data or to buy a larger GPU and train a larger neural network. Making these choices systematically can prevent months of work on an approach that was unlikely to perform well.
