# Week 3 labs — Advice for applying machine learning

| Course item | Local notebook |
| --- | --- |
| Optional Lab — Model Evaluation and Selection | `C2W3_Lab_01_Model_Evaluation_and_Selection.ipynb` |
| Optional Lab — Diagnosing Bias and Variance | `C2W3_Lab_02_Diagnosing_Bias_and_Variance.ipynb` |
| Practice Lab — Advice for Applying Machine Learning | `C2_W3_Assignment.ipynb` |

The notebooks are bundled with their utility modules, CSV datasets, images,
and plotting style. Run Jupyter from this `Labs` directory so paths such as
