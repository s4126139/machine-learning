...
|---|---|---|---|
| 1 | `ML_Viet2026A_w1_MLFoundations.pdf` / `54487651` | `W1_Foundations_of_ML/week01_lecture_slides.pdf` | Match — `571FC76A7A13DE34534B6674B623D491AB0FBAEA39E3D0B8D0BF3A0CF05D2A08` |
| 2 | `ML_Viet2026B_Regression.pdf` / `54726223` | `W2_Regression/Regression_Slides.pdf` | Match — `3BB925E359E1FC32EC4307A2052B695D3EBA3A43EA5537156E987C2F607F4628` |
| 2 | Chapter 7 PDF / `53328898` | `W2_Regression/mlpda_Chp7.pdf` | Match — `DEB7F2964E43D0C448E4DE189076684D71AC83CD586441BEC29C5D298215C25B` |
| 3 | `ML_Viet2026B_LogisticRegression.pdf` / `54989618` | `W3_Logistic_Regression_and_Regularisation/ML_Viet2026B_LogisticRegression.pdf` | Match — `09554BBDA90537892AC734FF883715139A55F57E1287E72B9808C5B29A1F6AA0` |
| 4 | `ML_Viet2025A_EvaluatingHypotheses.pdf` / `53329219` | `W4_Evaluating_Hypotheses/ML_Viet2025A_EvaluatingHypotheses.pdf` | Match — `FE344E7FBF25E1863345E5C15944E0E4A6A63681C985C0EF551FEEE1B0B37182` |
| 4 | `w4_ML_Viet2026B_EvaluatingHypotheses.pdf` / `55105400` | `W4_Evaluating_Hypotheses/w4_ML_Viet2026B_EvaluatingHypotheses.pdf` | Match — `C24AE8B7BF4CC7C25345E00B59CA8477AAD0638C65B7FB245A654498B2BD5044` |
| 4 | `MatrixOverview.pdf` / `53329214` | `W4_Evaluating_Hypotheses/MatrixOverview.pdf` | Match — `D15B571224D0D135DE16F58A648E26DDFA02978B2ABBE12C73EDCC11E826D5F7` |
| 5 | `ML_Viet2026_DecisionTree.pdf` / `55212905` | `W5_Decision_Trees/ML_Viet2026_DecisionTree.pdf` | Match — `4962783E770E48558B28D1BEBE875E331F951D27D4D2FAE5D053551EE695F563` |
| 6 | No slide attachment linked from current module | `W6_Artificial_Neural_Networks/ML_Viet2026B_NeuralNetworks.pdf` | Local-only; not verified as a current Canvas attachment |
| 7 | No lecture slide item | — | No Canvas slide file exposed |
| 8 | `ML_2026A_DeepLearning_w8.pdf` / `55633724` | `W8_Deep_Learning/ML_2026A_DeepLearning_w8.pdf` | Match — `DDDDC41492B9FF89F1CC7DB1D34747832EF85B4209D092B86E47974E1AE34E24` |
| 9 | `ML_Viet2026B_UnsupervisedLearning.pdf` / `55831376` | `W9_Unsupervised_Learning_and_CNNs/ML_Viet2026B_UnsupervisedLearning.pdf` | Match — `DDCEBD44E234BB154231DC357941D20A7D0295A911F71541F338AFAC01517558` |
| 10 | `ML_Viet2026B_PracticalMattersinML.pdf` / `55968771` | `W10_Practical_Issues_and_Unsupervised_Learning/ML_Viet2026B_PracticalMattersinML.pdf` | Match — `00F0650043FF7840E059B8A1119B0E35130E4170DC2305B213D48EB261F4A078` |
| 11 | Placeholder only; no downloadable slide | — | No Canvas file exposed on capture date |
| 12 | “Download lecture slides here (update soon)” | — | No Canvas file exposed on capture date |
...
| 6 | `Week6_DecisionTree_1.ipynb` / `55336351` | `W6_Artificial_Neural_Networks/Week6_DecisionTree_1.ipynb` | `D3500F7AB19BA22231740D3F6538C3598EAC510FBDACBC68142C9E9973595DE3` |
| 6 | `bank-full-new.csv` / `53329269` | `W6_Artificial_Neural_Networks/bank-full-new.csv` | `ADA45D7C04AC65E4BF1A0A27996E73510848C28095DD40DF9F5D4C153AF67931` |
| 8 | `w8_lab_exercises_MLP-1.ipynb` / `55731612` | `W8_Deep_Learning/w8_lab_exercises_MLP-1.ipynb` | `6A655AB44C592491CE89F7DB6A360ED3CC35AD57348B1B45B958267025AF82D6` |
| 8–9 | `CIFAR10_Lab9.zip` / `53328023` | `W9_Unsupervised_Learning_and_CNNs/CIFAR10_Lab9.zip` | `40BEF1E86568F90E84EE902487201FFE8F33E52874090C73A3235C0386EE626D`; Canvas links the same archive from both modules |
| 9 | `w9_Lab_DeepLearning.ipynb` / `53327668` | `W9_Unsupervised_Learning_and_CNNs/w9_Lab_DeepLearning.ipynb` | `2755007593DC057C26216F0C8D1DD06417A6DBA6AB1671BD014911AF7FAE46BB` |
| 10 | `w10_Unsupervised Learning_lab.ipynb` / `55969106` | `W10_Practical_Issues_and_Unsupervised_Learning/w10_Unsupervised Learning_lab.ipynb` | `19AA67C92BE2D3DF01D9F1310D243BADF4E285D9DA2DF6BD467A627CBEA311DD`; uses scikit-learn's built-in Iris data |

## Mismatches and unresolved Canvas items

- The Canvas Modules list places W6 under Neural Networks, W7 under Personal Development Week, W8 under Deep Learning, W9 under Unsupervised Learning, W10 under Practical Issues, W11 under Guest Lecture, and W12 under Review. The Syllabus page has conflicting/stale labels. The W folders follow the week topics recorded in this manifest.
- W3's lab performs regression under the Logistic Regression module.
- W5's module is Decision Tree Learning, but its lab and downloadable notebook teach logistic regression on NBA rookie data; the lab text also refers to a `nbaPlayers.csv` filename while the actual download is `nbaRookies.csv`.
- W6's module teaches neural networks but attaches a Decision Tree/Random Forest lab. Its local neural-network PDF is not linked from the current Canvas module.
- W8's lab is MLP/CIFAR-10 image classification; its downloaded slide deck covers Deep Learning/CNN background.
